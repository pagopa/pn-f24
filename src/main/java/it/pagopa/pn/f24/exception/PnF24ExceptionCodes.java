...
public class PnF24ExceptionCodes {
    ...
    public static final String ERROR_CODE_F24_SAVE_REQUEST_CONFLICT = "PN_F24_SAVEREQUESTCONFLICT";
    ...
    public static final String ERROR_CODE_F24_GENERATING_PDF = "PN_F24_METADATA_GENERATING_PDF_ERROR";
    public static final String ERROR_CODE_F24_FILE_GENERATION_IN_PROGRESS = "PN_F24_FILE_GENERATION_ERROR";
    public static final String ERROR_CODE_F24_PREPARE_PDF_VALIDATION_ERROR = "PN_F24_PREPARE_PDF_VALIDATION_ERROR";
    public static final String ERROR_CODE_F24_FILE_NOT_FOUND = "PN_F24_FILENOTFOUND";
