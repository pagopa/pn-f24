...
import it.pagopa.pn.f24.exception.EventBridgeSendException;
...
public abstract class AbstractEventBridgeProducer<T extends GenericEventBridgeEvent> implements EventBridgeProducer<T> {
    ...
    protected AbstractEventBridgeProducer(EventBridgeAsyncClient amazonEventBridge, String eventBusSource, String detailType, String name, JsonService jsonService) {
    ...
    private PutEventsRequestEntry buildEventRequest(T event) {
        return PutEventsRequestEntry.builder()
                ...
                .detail(jsonService.stringifyObject(event.getDetail()))
                .build();
    }
